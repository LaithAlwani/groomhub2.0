      ...
      <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            onClick={onApprove}
            disabled={busy}
            className="inline-flex items-center gap-1.5 rounded-lg bg-orange-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-orange-600 disabled:cursor-not-allowed disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-800 dark:disabled:text-zinc-500"
          >
            <Check size={14} />
            Confirm appointment
          </button>
